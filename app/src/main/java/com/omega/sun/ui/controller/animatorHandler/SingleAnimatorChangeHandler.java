 ...
 */
public abstract class SingleAnimatorChangeHandler extends ControllerChangeHandler {

    private static final String KEY_DURATION = "SingleAnimatorChangeHandler.duration";
    private static final String KEY_REMOVES_FROM_ON_PUSH = "SingleAnimatorChangeHandler.removesFromViewOnPush";
    ...
    @SuppressWarnings("WeakerAccess")
    public SingleAnimatorChangeHandler() {
        this(DEFAULT_ANIMATION_DURATION, true);
    }

    @SuppressWarnings("WeakerAccess")
    public SingleAnimatorChangeHandler(boolean removesFromViewOnPush) {
        this(DEFAULT_ANIMATION_DURATION, removesFromViewOnPush);
    }

    @SuppressWarnings("WeakerAccess")
    public SingleAnimatorChangeHandler(long duration) {
        this(duration, true);
    }

    public SingleAnimatorChangeHandler(long duration, boolean removesFromViewOnPush) {
