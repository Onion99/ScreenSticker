...
import com.omega.recyclerview.BatchingListUpdateCallback;
import com.omega.recyclerview.DiffUtil;
import com.omega.recyclerview.ListUpdateCallback;
 ...
 * list
 * such that it can be bound to a {@link com.omega.recyclerview.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    /**
     * Replaces the current items with the new items, dispatching {@link com.omega.recyclerview.ListUpdateCallback} events
     ...
     * {@link com.omega.recyclerview.ListUpdateCallback#onMoved(int, int)} events. It instead treats moves as a remove
     * followed by an add and therefore dispatches {@link com.omega.recyclerview.ListUpdateCallback#onRemoved(int, int)}
     * and {@link com.omega.recyclerview.ListUpdateCallback#onRemoved(int, int)} events.  See {@link DiffUtil} if you want
    ...
    public static abstract class Callback<T2> implements Comparator<T2>, ListUpdateCallback {
         ...
         * {@link com.omega.recyclerview.RecyclerView.Adapter RecyclerView.Adapter}, you should
         ...
         * {@link com.omega.recyclerview.RecyclerView}, you can return the particular field that
    ...
    public static class BatchedCallback<T2> extends Callback<T2> {
        ...
        private final com.omega.recyclerview.BatchingListUpdateCallback mBatchingListUpdateCallback;
        /**
