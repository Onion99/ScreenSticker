...
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_POST;
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_PRE;
import static com.omega.recyclerview.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
...
class ViewInfoStore {
     ...
     */
    @VisibleForTesting
    final SimpleArrayMap<com.omega.recyclerview.RecyclerView.ViewHolder, InfoRecord> mLayoutHolderMap =
            new SimpleArrayMap<>();

    @VisibleForTesting
    final LongSparseArray<com.omega.recyclerview.RecyclerView.ViewHolder> mOldChangedHolders = new LongSparseArray<>();
     ...
     */
    void addToPreLayout(com.omega.recyclerview.RecyclerView.ViewHolder holder, com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo info) {
    ...
    boolean isDisappearing(com.omega.recyclerview.RecyclerView.ViewHolder holder) {
     ...
     */
    @Nullable
    com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo popFromPreLayout(com.omega.recyclerview.RecyclerView.ViewHolder vh) {
     ...
     */
    @Nullable
    com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo popFromPostLayout(com.omega.recyclerview.RecyclerView.ViewHolder vh) {
        return popFromLayoutStep(vh, InfoRecord.FLAG_POST);
    }

    private com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(com.omega.recyclerview.RecyclerView.ViewHolder vh, int flag) {
        ...
        if (record != null && (record.flags & flag) != 0) {
            record.flags &= ~flag;
            final com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo info;
     ...
     */
    void addToOldChangeHolders(long key, com.omega.recyclerview.RecyclerView.ViewHolder holder) {
     ...
     * @param info The information to save
     */
    void addToAppearedInPreLayoutHolders(com.omega.recyclerview.RecyclerView.ViewHolder holder, com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo info) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            record = InfoRecord.obtain();
            mLayoutHolderMap.put(holder, record);
     ...
     */
    boolean isInPreLayout(com.omega.recyclerview.RecyclerView.ViewHolder viewHolder) {
     ...
     */
    com.omega.recyclerview.RecyclerView.ViewHolder getFromOldChangeHolders(long key) {
     ...
     * @param info The information to save
     */
    void addToPostLayout(com.omega.recyclerview.RecyclerView.ViewHolder holder, com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo info) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            record = InfoRecord.obtain();
            mLayoutHolderMap.put(holder, record);
     ...
     */
    void addToDisappearedInLayout(com.omega.recyclerview.RecyclerView.ViewHolder holder) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            record = InfoRecord.obtain();
            mLayoutHolderMap.put(holder, record);
     ...
     */
    void removeFromDisappearedInLayout(com.omega.recyclerview.RecyclerView.ViewHolder holder) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            return;
        }
    ...
    void process(ProcessCallback callback) {
        for (int index = mLayoutHolderMap.size() - 1; index >= 0; index--) {
            final com.omega.recyclerview.RecyclerView.ViewHolder viewHolder = mLayoutHolderMap.keyAt(index);
     ...
     */
    void removeViewHolder(com.omega.recyclerview.RecyclerView.ViewHolder holder) {
    ...
    public void onViewDetached(com.omega.recyclerview.RecyclerView.ViewHolder viewHolder) {
        removeFromDisappearedInLayout(viewHolder);
    }

    interface ProcessCallback {
        void processDisappeared(com.omega.recyclerview.RecyclerView.ViewHolder viewHolder, @NonNull com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                                @Nullable com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void processAppeared(com.omega.recyclerview.RecyclerView.ViewHolder viewHolder, @Nullable com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                             com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void processPersistent(com.omega.recyclerview.RecyclerView.ViewHolder viewHolder, @NonNull com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                               @NonNull com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void unused(com.omega.recyclerview.RecyclerView.ViewHolder holder);
    }
    ...
    static class InfoRecord {
        ...
        int flags;
        @Nullable
        com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo preInfo;
        @Nullable
