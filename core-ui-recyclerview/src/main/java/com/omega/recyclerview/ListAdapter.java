...
import com.omega.recyclerview.AdapterListUpdateCallback;
import com.omega.recyclerview.AsyncDifferConfig;
 ...
 * <p>
 * This class is a convenience wrapper around {@link com.omega.recyclerview.AsyncListDiffer} that implements Adapter common
 ...
 * class should refer to {@link com.omega.recyclerview.AsyncListDiffer}, which provides custom mapping from diff events
...
public abstract class ListAdapter<T, VH extends RecyclerView.ViewHolder>
    ...
    final com.omega.recyclerview.AsyncListDiffer<T> mDiffer;
    private final com.omega.recyclerview.AsyncListDiffer.ListListener<T> mListener =
            new com.omega.recyclerview.AsyncListDiffer.ListListener<T>() {
        @Override
    ...
    protected ListAdapter(@NonNull DiffUtil.ItemCallback<T> diffCallback) {
        mDiffer = new com.omega.recyclerview.AsyncListDiffer<>(new com.omega.recyclerview.AdapterListUpdateCallback(this),
                new com.omega.recyclerview.AsyncDifferConfig.Builder<>(diffCallback).build());
