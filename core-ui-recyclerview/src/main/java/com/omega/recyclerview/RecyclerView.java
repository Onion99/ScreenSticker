...
import com.omega.recyclerview.AsyncListDiffer;
import com.omega.recyclerview.ChildHelper;
import com.omega.recyclerview.DefaultItemAnimator;
import com.omega.recyclerview.DiffUtil;
import com.omega.recyclerview.FastScroller;
import com.omega.recyclerview.GapWorker;
...
import com.omega.recyclerview.RecyclerView.ItemAnimator.ItemHolderInfo;
import com.omega.recyclerview.RecyclerViewAccessibilityDelegate;
import com.omega.recyclerview.SortedList;
import com.omega.recyclerview.ViewBoundsCheck;
import com.omega.recyclerview.ViewInfoStore;
 ...
 * from the network, or from a database), {@link com.omega.recyclerview.DiffUtil} can calculate the difference between
 ...
 * the PagedList class that operates as a self-loading list, provided a
...
public class RecyclerView extends ViewGroup implements ScrollingView,
     ...
     */
    com.omega.recyclerview.AdapterHelper mAdapterHelper;

    /**
     * Handles abstraction between LayoutManager children and RecyclerView children
     */
    com.omega.recyclerview.ChildHelper mChildHelper;
    ...
    ItemAnimator mItemAnimator = new com.omega.recyclerview.DefaultItemAnimator();
    ...
    com.omega.recyclerview.GapWorker mGapWorker;
    com.omega.recyclerview.GapWorker.LayoutPrefetchRegistryImpl mPrefetchRegistry =
            ALLOW_THREAD_GAP_WORK ? new com.omega.recyclerview.GapWorker.LayoutPrefetchRegistryImpl() : null;
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        PoolingContainerKt.setPoolingContainer(this, true);
    }
    ...
    public CharSequence getAccessibilityClassName() {
        return "com.omega.recyclerview.RecyclerView";
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new com.omega.recyclerview.ChildHelper(new com.omega.recyclerview.ChildHelper.Callback() {
            @Override
    ...
    void initAdapterManager() {
        mAdapterHelper = new com.omega.recyclerview.AdapterHelper(new com.omega.recyclerview.AdapterHelper.Callback() {
            @Override
            ...
            @Override
            public void onDispatchFirstPass(com.omega.recyclerview.AdapterHelper.UpdateOp op) {
                dispatchUpdate(op);
            }

            void dispatchUpdate(com.omega.recyclerview.AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    ...
                    case com.omega.recyclerview.AdapterHelper.UpdateOp.REMOVE:
                        ...
                        break;
                    case com.omega.recyclerview.AdapterHelper.UpdateOp.UPDATE:
            ...
            @Override
            public void onDispatchSecondPass(com.omega.recyclerview.AdapterHelper.UpdateOp op) {
                dispatchUpdate(op);
            }
    ...
    public void setTargetTouchSlop(int sensitivity) {
        mTouchSlop = mTouchSlop * sensitivity;
    }
    ...
    void consumePendingUpdateOperations() {
        ...
        if (mAdapterHelper.hasAnyUpdateTypes(com.omega.recyclerview.AdapterHelper.UpdateOp.UPDATE) && !mAdapterHelper
                .hasAnyUpdateTypes(com.omega.recyclerview.AdapterHelper.UpdateOp.ADD | com.omega.recyclerview.AdapterHelper.UpdateOp.REMOVE
                        | com.omega.recyclerview.AdapterHelper.UpdateOp.MOVE)) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            mGapWorker = com.omega.recyclerview.GapWorker.sGapWorker.get();
            if (mGapWorker == null) {
                mGapWorker = new com.omega.recyclerview.GapWorker();
                ...
                com.omega.recyclerview.GapWorker.sGapWorker.set(mGapWorker);
            }
            mGapWorker.add(this);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        PoolingContainerKt.callPoolingContainerOnReleaseForChildren(this);
     ...
     * uses an instance of {@link com.omega.recyclerview.DefaultItemAnimator}. Whether item animations are
     ...
     * uses an instance of {@link com.omega.recyclerview.DefaultItemAnimator}.
     *
            ...
            if (otherKey == key) {
                if (mAdapter != null && mAdapter.hasStableIds()) {
                    if(BuildConfig.DEBUG){
                        Toast.makeText(getContext(),"Two different ViewHolders have the same stable"
                                + " ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT"
                                + " change.\n ViewHolder 1:" + other + " \n View Holder 2:" + holder
                                + exceptionLabel(),Toast.LENGTH_LONG).show();
                    }
                } else {
                    if(BuildConfig.DEBUG){
                        Toast.makeText(getContext(),"Two different ViewHolders have the same change"
    ...
    public static class RecycledViewPool {
         ...
         * constructed by {@link com.omega.recyclerview.GapWorker} prefetch from being bound to a lower priority prefetch.
         */
         ...
         * attached) and for PoolingContainerKt release are tracked separately to maintain the
         ...
         *
         * The attached adapters for PoolingContainerKt purposes strives to be more accurate, as
        ...
        /**
         * The set of adapters for PoolingContainerKt release purposes
         *
        ...
        public void clear() {
            for (int i = 0; i < mScrap.size(); i++) {
                ...
                for (ViewHolder scrap: data.mScrapHeap) {
                    PoolingContainerKt.callPoolingContainerOnRelease(scrap.itemView);
                }
        ...
        /**
         * Adds this adapter to the set of adapters being tracked for PoolingContainerKt release
        ...
        /**
         * Removes this adapter from the set of adapters being tracked for PoolingContainerKt
            ...
            if (mAttachedAdaptersForPoolingContainer.size() == 0 && !isBeingReplaced) {
                for (int keyIndex = 0; keyIndex < mScrap.size(); keyIndex++) {
                    ...
                    for (int i = 0; i < scrapHeap.size(); i++) {
                        PoolingContainerKt.callPoolingContainerOnRelease(
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                if(BuildConfig.DEBUG){
                    ...
                    Toast.makeText(getContext(),"Scrapped or attached views may not be recycled",Toast.LENGTH_LONG).show();
                    return;
                }
            }
            ...
            if (!cached && !recycled && transientStatePreventsRecycling) {
                PoolingContainerKt.callPoolingContainerOnRelease(holder.itemView);
                holder.mBindingAdapter = null;
        ...
        void onDetachedFromWindow() {
            for (int i = 0; i < mCachedViews.size(); i++) {
                PoolingContainerKt.callPoolingContainerOnRelease(mCachedViews.get(i).itemView);
            }
            poolingContainerDetach(mAdapter);
        }
    ...
    public abstract static class LayoutManager {
         ...
         * {@link com.omega.recyclerview.LinearLayoutManager#findOneVisibleChild(int, int, boolean, boolean)},
        ...
        /**
         * Written by {@link com.omega.recyclerview.GapWorker} when prefetches occur to track largest number of view ever
         ...
         * way. For example, the default ItemAnimator, {@link com.omega.recyclerview.DefaultItemAnimator}, will
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable,
        ...
        new com.omega.recyclerview.FastScroller(this, verticalThumbDrawable, verticalTrackDrawable,
                horizontalThumbDrawable, horizontalTrackDrawable,
     ...
     *
     * @see com.omega.recyclerview.LinearSmoothScroller
     */
    public abstract static class SmoothScroller {
        ...
        public interface ScrollVectorProvider {
             ...
             * can be found.
             * <p>
             * This method is used by the {@link com.omega.recyclerview.LinearSmoothScroller} to initiate a scroll towards
             * the target position.
             * <p>
     ...
     *
     * <p>By default, RecyclerView uses {@link com.omega.recyclerview.DefaultItemAnimator}.</p>
     *
    ...
    public abstract static class ItemAnimator {
         ...
         * adapter. {@link com.omega.recyclerview.DefaultItemAnimator} will skip animating the View if its location on the
