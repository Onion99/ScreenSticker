...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    final com.omega.recyclerview.RecyclerView mRecyclerView;
    private final ItemDelegate mItemDelegate;

    public RecyclerViewAccessibilityDelegate(@NonNull com.omega.recyclerview.RecyclerView recyclerView) {
    ...
    public void onInitializeAccessibilityEvent(
        ...
        if (host instanceof com.omega.recyclerview.RecyclerView && !shouldIgnore()) {
            com.omega.recyclerview.RecyclerView rv = (RecyclerView) host;
