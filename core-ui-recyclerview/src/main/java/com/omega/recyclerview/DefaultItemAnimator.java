...
import com.omega.recyclerview.SimpleItemAnimator;
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                if(view != null) ViewCompat.postOnAnimationDelayed(view, mover, getRemoveDuration());
            } else {
                mover.run();
            }
        }
        ...
        if (changesPending) {
            ...
            if (removalsPending) {
                ...
                if(holder.itemView != null) ViewCompat.postOnAnimationDelayed(holder.itemView, changer, getRemoveDuration());
            } else {
                changer.run();
            }
        }
        ...
        if (additionsPending) {
            ...
            if (removalsPending || movesPending || changesPending) {
                ...
                if(view != null) ViewCompat.postOnAnimationDelayed(view, adder, totalDelay);
            } else {
                adder.run();
            }
        }
