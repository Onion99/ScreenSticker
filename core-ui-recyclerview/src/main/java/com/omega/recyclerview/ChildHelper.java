...
class ChildHelper {
    ...
    void hide(View view) {
        ...
        if (offset < 0) {
            String errorMsg = "view is not a child, cannot hide " + view;
            if(DEBUG) throw new IllegalArgumentException(errorMsg);
            else {
                Timber.e(errorMsg);
                return;
            }
    ...
    void unhide(View view) {
        ...
        if (offset < 0 ) {
            String errorMsg = "view is not a child, cannot hide " + view;
            if(BuildConfig.DEBUG) throw new IllegalArgumentException(errorMsg);
            else {
                Timber.e(errorMsg);
                return;
            }
        ...
        if (!mBucket.get(offset)) {
            String errorMsg = "trying to unhide a view that was not hidden" + view;
            if(BuildConfig.DEBUG) throw new RuntimeException(errorMsg);
            else {
                Timber.e(errorMsg);
                return;
            }
