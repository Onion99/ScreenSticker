...
import com.omega.recyclerview.SnapHelper;
...
public class PagerSnapHelper extends SnapHelper {
    ...
    @Nullable
    private com.omega.recyclerview.OrientationHelper mVerticalHelper;
    @Nullable
    private com.omega.recyclerview.OrientationHelper mHorizontalHelper;
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX,
        ...
        final com.omega.recyclerview.OrientationHelper orientationHelper = getOrientationHelper(layoutManager);
    ...
    private int distanceToCenter(@NonNull View targetView, com.omega.recyclerview.OrientationHelper helper) {
     ...
     *                      {@link RecyclerView}.
     * @param helper The relevant {@link com.omega.recyclerview.OrientationHelper} for the attached {@link RecyclerView}.
     *
     * @return the child view that is currently closest to the center of this parent.
     */
    @Nullable
    private View findCenterView(RecyclerView.LayoutManager layoutManager,
            com.omega.recyclerview.OrientationHelper helper) {
    ...
    @Nullable
    private com.omega.recyclerview.OrientationHelper getOrientationHelper(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager.canScrollVertically()) {
    ...
    @NonNull
    private com.omega.recyclerview.OrientationHelper getVerticalHelper(@NonNull RecyclerView.LayoutManager layoutManager) {
        if (mVerticalHelper == null || mVerticalHelper.mLayoutManager != layoutManager) {
            mVerticalHelper = com.omega.recyclerview.OrientationHelper.createVerticalHelper(layoutManager);
        }
        return mVerticalHelper;
    }

    @NonNull
    private com.omega.recyclerview.OrientationHelper getHorizontalHelper(
            @NonNull RecyclerView.LayoutManager layoutManager) {
