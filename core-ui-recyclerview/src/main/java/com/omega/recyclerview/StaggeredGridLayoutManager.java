...
package com.omega.recyclerview;
...
import com.omega.recyclerview.AdapterHelper;
import com.omega.recyclerview.LayoutState;
import com.omega.recyclerview.LinearSmoothScroller;
import com.omega.recyclerview.OrientationHelper;
import com.omega.recyclerview.RecyclerView;
import com.omega.recyclerview.ScrollbarHelper;
 ...
 */
public class StaggeredGridLayoutManager extends com.omega.recyclerview.RecyclerView.LayoutManager implements
        com.omega.recyclerview.RecyclerView.SmoothScroller.ScrollVectorProvider {

    private static final String TAG = "StaggeredGridLManager";

    static final boolean DEBUG = false;

    public static final int HORIZONTAL = com.omega.recyclerview.RecyclerView.HORIZONTAL;

    public static final int VERTICAL = com.omega.recyclerview.RecyclerView.VERTICAL;
    ...
    /**
     * When scroll state is changed to {@link com.omega.recyclerview.RecyclerView#SCROLL_STATE_IDLE}, StaggeredGrid will
     ...
     */
    @NonNull
    com.omega.recyclerview.OrientationHelper mPrimaryOrientation;
    @NonNull
    com.omega.recyclerview.OrientationHelper mSecondaryOrientation;
    ...
    @NonNull
    private final com.omega.recyclerview.LayoutState mLayoutState;
     ...
     */
    int mPendingScrollPosition = com.omega.recyclerview.RecyclerView.NO_POSITION;
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mLayoutState = new com.omega.recyclerview.LayoutState();
    ...
    private void createOrientationHelpers() {
        mPrimaryOrientation = com.omega.recyclerview.OrientationHelper.createOrientationHelper(this, mOrientation);
        mSecondaryOrientation = com.omega.recyclerview.OrientationHelper
    ...
    boolean checkForGaps() {
        ...
        int invalidGapDir = mShouldReverseLayout ? com.omega.recyclerview.LayoutState.LAYOUT_START : com.omega.recyclerview.LayoutState.LAYOUT_END;
    ...
    public void onScrollStateChanged(int state) {
        if (state == com.omega.recyclerview.RecyclerView.SCROLL_STATE_IDLE) {
            checkForGaps();
        }
    }

    @Override
    public void onDetachedFromWindow(com.omega.recyclerview.RecyclerView view, com.omega.recyclerview.RecyclerView.Recycler recycler) {
     ...
     * When set to true, If {@link com.omega.recyclerview.RecyclerView} is LTR, than it will layout from RTL, if
     * {@link com.omega.recyclerview.RecyclerView}} is RTL, it will layout from LTR.
     *
    ...
    @Override
    public void onLayoutChildren(com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.RecyclerView.State state) {
        onLayoutChildren(recycler, state, true);
    }

    @Override
    public void onAdapterChanged(@Nullable com.omega.recyclerview.RecyclerView.Adapter oldAdapter,
            @Nullable com.omega.recyclerview.RecyclerView.Adapter newAdapter) {
    ...
    private void onLayoutChildren(com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.RecyclerView.State state,
                                  boolean shouldCheckForGaps) {
        final AnchorInfo anchorInfo = mAnchorInfo;
        if (mPendingSavedState != null || mPendingScrollPosition != com.omega.recyclerview.RecyclerView.NO_POSITION) {
        ...
        boolean recalculateAnchor = !anchorInfo.mValid || mPendingScrollPosition != com.omega.recyclerview.RecyclerView.NO_POSITION
        ...
        if (anchorInfo.mLayoutFromEnd) {
            // Layout start.
            setLayoutStateDirection(com.omega.recyclerview.LayoutState.LAYOUT_START);
            fill(recycler, mLayoutState, state);
            // Layout end.
            setLayoutStateDirection(com.omega.recyclerview.LayoutState.LAYOUT_END);
    ...
    @Override
    public void onLayoutCompleted(com.omega.recyclerview.RecyclerView.State state) {
        super.onLayoutCompleted(state);
        mPendingScrollPosition = com.omega.recyclerview.RecyclerView.NO_POSITION;
    ...
    private void applyPendingSavedState(AnchorInfo anchorInfo) {
        ...
        if (mPendingSavedState.mAnchorPosition != com.omega.recyclerview.RecyclerView.NO_POSITION) {
    ...
    void updateAnchorInfoForLayout(com.omega.recyclerview.RecyclerView.State state, AnchorInfo anchorInfo) {
    ...
    private boolean updateAnchorFromChildren(com.omega.recyclerview.RecyclerView.State state, AnchorInfo anchorInfo) {
    ...
    boolean updateAnchorFromPendingData(com.omega.recyclerview.RecyclerView.State state, AnchorInfo anchorInfo) {
        // Validate scroll position if exists.
        if (state.isPreLayout() || mPendingScrollPosition == com.omega.recyclerview.RecyclerView.NO_POSITION) {
            return false;
        }
        // Validate it.
        ...
        if (mPendingSavedState == null || mPendingSavedState.mAnchorPosition == com.omega.recyclerview.RecyclerView.NO_POSITION
                || mPendingSavedState.mSpanOffsetsSize < 1) {
            ...
            if (child != null) {
                ...
                if (mPendingScrollPositionOffset == INVALID_OFFSET) {
                    ...
                    anchorInfo.mLayoutFromEnd = position == com.omega.recyclerview.LayoutState.LAYOUT_END;
                    anchorInfo.assignCoordinateFromPadding();
                } else {
     ...
     * any items, {@link com.omega.recyclerview.RecyclerView#NO_POSITION} is returned for that span.
     ...
     * not have any items, {@link com.omega.recyclerview.RecyclerView#NO_POSITION} is returned for that span.
     ...
     * have any items, {@link com.omega.recyclerview.RecyclerView#NO_POSITION} is returned for that span.
     * @see #findFirstCompletelyVisibleItemPositions(int[])
     * @see #findLastVisibleItemPositions(int[])
     */
    ...
    @Override
    public int computeHorizontalScrollOffset(com.omega.recyclerview.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    private int computeScrollOffset(com.omega.recyclerview.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        return com.omega.recyclerview.ScrollbarHelper.computeScrollOffset(state, mPrimaryOrientation,
    ...
    @Override
    public int computeVerticalScrollOffset(com.omega.recyclerview.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeHorizontalScrollExtent(com.omega.recyclerview.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    private int computeScrollExtent(com.omega.recyclerview.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        return com.omega.recyclerview.ScrollbarHelper.computeScrollExtent(state, mPrimaryOrientation,
                findFirstVisibleItemClosestToStart(!mSmoothScrollbarEnabled),
                findFirstVisibleItemClosestToEnd(!mSmoothScrollbarEnabled),
    ...
    @Override
    public int computeVerticalScrollExtent(com.omega.recyclerview.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeHorizontalScrollRange(com.omega.recyclerview.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    private int computeScrollRange(com.omega.recyclerview.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        return com.omega.recyclerview.ScrollbarHelper.computeScrollRange(state, mPrimaryOrientation,
                findFirstVisibleItemClosestToStart(!mSmoothScrollbarEnabled),
                findFirstVisibleItemClosestToEnd(!mSmoothScrollbarEnabled),
                this, mSmoothScrollbarEnabled);
    }
    ...
    @Override
    public int computeVerticalScrollRange(com.omega.recyclerview.RecyclerView.State state) {
        return computeScrollRange(state);
    }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof SavedState) {
            ...
            if (mPendingScrollPosition != com.omega.recyclerview.RecyclerView.NO_POSITION) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            state.mAnchorPosition = com.omega.recyclerview.RecyclerView.NO_POSITION;
            state.mVisibleAnchorPosition = com.omega.recyclerview.RecyclerView.NO_POSITION;
    ...
    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull com.omega.recyclerview.RecyclerView.Recycler recycler,
                                                  @NonNull com.omega.recyclerview.RecyclerView.State state, @NonNull AccessibilityNodeInfoCompat info) {
        ...
        // semantics.
        info.setClassName("com.omega.recyclerview.StaggeredGridLayoutManager");
    }

    @Override
    public void onInitializeAccessibilityNodeInfoForItem(@NonNull com.omega.recyclerview.RecyclerView.Recycler recycler,
                                                         @NonNull com.omega.recyclerview.RecyclerView.State state, @NonNull View host,
    ...
    int findFirstVisibleItemPositionInt() {
        ...
        return first == null ? com.omega.recyclerview.RecyclerView.NO_POSITION : getPosition(first);
    }

    @Override
    public int getRowCountForAccessibility(@NonNull com.omega.recyclerview.RecyclerView.Recycler recycler,
            @NonNull com.omega.recyclerview.RecyclerView.State state) {
        if (mOrientation == HORIZONTAL) {
    ...
    @Override
    public int getColumnCountForAccessibility(@NonNull com.omega.recyclerview.RecyclerView.Recycler recycler,
            @NonNull com.omega.recyclerview.RecyclerView.State state) {
        if (mOrientation == VERTICAL) {
            return Math.min(mSpanCount, state.getItemCount());
        }
    ...
    private void fixEndGap(com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.RecyclerView.State state,
    ...
    private void fixStartGap(com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.RecyclerView.State state,
                             boolean canOffsetChildren) {
    ...
    private void updateLayoutState(int anchorPosition, com.omega.recyclerview.RecyclerView.State state) {
        ...
        if (isSmoothScrolling()) {
            ...
            if (targetPos != com.omega.recyclerview.RecyclerView.NO_POSITION) {
    ...
    private void setLayoutStateDirection(int direction) {
        ...
        mLayoutState.mItemDirection = (mShouldReverseLayout == (direction == com.omega.recyclerview.LayoutState.LAYOUT_START))
                ? com.omega.recyclerview.LayoutState.ITEM_DIRECTION_TAIL : com.omega.recyclerview.LayoutState.ITEM_DIRECTION_HEAD;
    }
    ...
    @Override
    public void onItemsRemoved(com.omega.recyclerview.RecyclerView recyclerView, int positionStart, int itemCount) {
        handleUpdate(positionStart, itemCount, com.omega.recyclerview.AdapterHelper.UpdateOp.REMOVE);
    }

    @Override
    public void onItemsAdded(com.omega.recyclerview.RecyclerView recyclerView, int positionStart, int itemCount) {
        handleUpdate(positionStart, itemCount, com.omega.recyclerview.AdapterHelper.UpdateOp.ADD);
    }

    @Override
    public void onItemsChanged(com.omega.recyclerview.RecyclerView recyclerView) {
        mLazySpanLookup.clear();
        requestLayout();
    }

    @Override
    public void onItemsMoved(com.omega.recyclerview.RecyclerView recyclerView, int from, int to, int itemCount) {
        handleUpdate(from, to, com.omega.recyclerview.AdapterHelper.UpdateOp.MOVE);
    }

    @Override
    public void onItemsUpdated(com.omega.recyclerview.RecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        handleUpdate(positionStart, itemCount, com.omega.recyclerview.AdapterHelper.UpdateOp.UPDATE);
    }
    ...
    private void handleUpdate(int positionStart, int itemCountOrToPosition, int cmd) {
        ...
        if (cmd == com.omega.recyclerview.AdapterHelper.UpdateOp.MOVE) {
        ...
        switch (cmd) {
            case com.omega.recyclerview.AdapterHelper.UpdateOp.ADD:
                mLazySpanLookup.offsetForAddition(positionStart, itemCountOrToPosition);
                break;
            case com.omega.recyclerview.AdapterHelper.UpdateOp.REMOVE:
                mLazySpanLookup.offsetForRemoval(positionStart, itemCountOrToPosition);
                break;
            case com.omega.recyclerview.AdapterHelper.UpdateOp.MOVE:
                // TODO optimize
    ...
    private int fill(com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.LayoutState layoutState,
                     com.omega.recyclerview.RecyclerView.State state) {
        ...
        if (mLayoutState.mInfinite) {
            if (layoutState.mLayoutDirection == com.omega.recyclerview.LayoutState.LAYOUT_END) {
        ...
        while (layoutState.hasMore(state)
            ...
            if (layoutState.mLayoutDirection == com.omega.recyclerview.LayoutState.LAYOUT_END) {
                ...
                if (assignSpan && lp.mFullSpan) {
                    ...
                    fullSpanItem.mGapDir = com.omega.recyclerview.LayoutState.LAYOUT_START;
                ...
                if (assignSpan && lp.mFullSpan) {
                    ...
                    fullSpanItem.mGapDir = com.omega.recyclerview.LayoutState.LAYOUT_END;
                    fullSpanItem.mPosition = position;
                    mLazySpanLookup.addFullSpanItem(fullSpanItem);
                }
            }
            ...
            if (lp.mFullSpan && layoutState.mItemDirection == com.omega.recyclerview.LayoutState.ITEM_DIRECTION_HEAD) {
                if (assignSpan) {
        ...
        final int diff;
        if (mLayoutState.mLayoutDirection == com.omega.recyclerview.LayoutState.LAYOUT_START) {
    ...
    private void attachViewToSpans(View view, LayoutParams lp, com.omega.recyclerview.LayoutState layoutState) {
        if (layoutState.mLayoutDirection == com.omega.recyclerview.LayoutState.LAYOUT_END) {
            if (lp.mFullSpan) {
    ...
    private void recycle(com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.LayoutState layoutState) {
        if (!layoutState.mRecycle || layoutState.mInfinite) {
            return;
        }
        if (layoutState.mAvailable == 0) {
            // easy, recycle line is still valid
            if (layoutState.mLayoutDirection == com.omega.recyclerview.LayoutState.LAYOUT_START) {
    ...
    private void updateRemainingSpans(Span span, int layoutDir, int targetLine) {
        ...
        if (layoutDir == com.omega.recyclerview.LayoutState.LAYOUT_START) {
    ...
    private void recycleFromStart(com.omega.recyclerview.RecyclerView.Recycler recycler, int line) {
    ...
    private void recycleFromEnd(com.omega.recyclerview.RecyclerView.Recycler recycler, int line) {
        final int childCount = getChildCount();
        int i;
    ...
    private boolean preferLastSpan(int layoutDir) {
        if (mOrientation == HORIZONTAL) {
            return (layoutDir == com.omega.recyclerview.LayoutState.LAYOUT_START) != mShouldReverseLayout;
        }
        return ((layoutDir == com.omega.recyclerview.LayoutState.LAYOUT_START) == mShouldReverseLayout) == isLayoutRTL();
    }

    /**
     * Finds the span for the next view.
     */
    private Span getNextSpan(com.omega.recyclerview.LayoutState layoutState) {
    ...
    @Override
    public int scrollHorizontallyBy(int dx, com.omega.recyclerview.RecyclerView.Recycler recycler,
            com.omega.recyclerview.RecyclerView.State state) {
        return scrollBy(dx, recycler, state);
    }

    @Override
    public int scrollVerticallyBy(int dy, com.omega.recyclerview.RecyclerView.Recycler recycler,
            com.omega.recyclerview.RecyclerView.State state) {
    ...
    private int calculateScrollDirectionForPosition(int position) {
        if (getChildCount() == 0) {
            return mShouldReverseLayout ? com.omega.recyclerview.LayoutState.LAYOUT_END : com.omega.recyclerview.LayoutState.LAYOUT_START;
        }
        final int firstChildPos = getFirstChildPosition();
        return position < firstChildPos != mShouldReverseLayout ? com.omega.recyclerview.LayoutState.LAYOUT_START : com.omega.recyclerview.LayoutState.LAYOUT_END;
    }
    ...
    @Override
    public void smoothScrollToPosition(com.omega.recyclerview.RecyclerView recyclerView, com.omega.recyclerview.RecyclerView.State state,
                                       int position) {
        com.omega.recyclerview.LinearSmoothScroller scroller = new LinearSmoothScroller(recyclerView.getContext());
    ...
    @Override
    @RestrictTo(LIBRARY)
    public void collectAdjacentPrefetchPositions(int dx, int dy, com.omega.recyclerview.RecyclerView.State state,
        ...
        for (int i = 0; i < mSpanCount; i++) {
            ...
            int distance = mLayoutState.mItemDirection == com.omega.recyclerview.LayoutState.LAYOUT_START
    ...
    void prepareLayoutStateForDelta(int delta, com.omega.recyclerview.RecyclerView.State state) {
        final int referenceChildPosition;
        final int layoutDir;
        if (delta > 0) { // layout towards end
            layoutDir = com.omega.recyclerview.LayoutState.LAYOUT_END;
            referenceChildPosition = getLastChildPosition();
        } else {
            layoutDir = com.omega.recyclerview.LayoutState.LAYOUT_START;
    ...
    int scrollBy(int dt, com.omega.recyclerview.RecyclerView.Recycler recycler, com.omega.recyclerview.RecyclerView.State state) {
    ...
    @Override
    public com.omega.recyclerview.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == HORIZONTAL) {
    ...
    @Override
    public com.omega.recyclerview.RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    @Override
    public com.omega.recyclerview.RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Override
    public boolean checkLayoutParams(com.omega.recyclerview.RecyclerView.LayoutParams lp) {
    ...
    @Nullable
    @Override
    public View onFocusSearchFailed(View focused, int direction, com.omega.recyclerview.RecyclerView.Recycler recycler,
            com.omega.recyclerview.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return null;
        }
        ...
        if (layoutDir == com.omega.recyclerview.LayoutState.INVALID_LAYOUT) {
            return null;
        }
        ...
        final int referenceChildPosition;
        if (layoutDir == com.omega.recyclerview.LayoutState.LAYOUT_END) { // layout towards end
            referenceChildPosition = getLastChildPosition();
        } else {
            referenceChildPosition = getFirstChildPosition();
        }
        ...
        boolean shouldSearchFromStart = !mReverseLayout == (layoutDir == com.omega.recyclerview.LayoutState.LAYOUT_START);
     ...
     * @return {@link com.omega.recyclerview.LayoutState#LAYOUT_START} or {@link com.omega.recyclerview.LayoutState#LAYOUT_END} if focus direction
     * is applicable to current state, {@link com.omega.recyclerview.LayoutState#INVALID_LAYOUT} otherwise.
     */
    private int convertFocusDirectionToLayoutDirection(int focusDirection) {
        switch (focusDirection) {
            case View.FOCUS_BACKWARD:
                if (mOrientation == VERTICAL) {
                    return com.omega.recyclerview.LayoutState.LAYOUT_START;
                } else if (isLayoutRTL()) {
                    return com.omega.recyclerview.LayoutState.LAYOUT_END;
                } else {
                    return com.omega.recyclerview.LayoutState.LAYOUT_START;
                }
            ...
            case View.FOCUS_UP:
                return mOrientation == VERTICAL ? com.omega.recyclerview.LayoutState.LAYOUT_START
                        : com.omega.recyclerview.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_DOWN:
                return mOrientation == VERTICAL ? com.omega.recyclerview.LayoutState.LAYOUT_END
                        : com.omega.recyclerview.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_LEFT:
                return mOrientation == HORIZONTAL ? com.omega.recyclerview.LayoutState.LAYOUT_START
                        : com.omega.recyclerview.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_RIGHT:
                return mOrientation == HORIZONTAL ? com.omega.recyclerview.LayoutState.LAYOUT_END
                        : com.omega.recyclerview.LayoutState.INVALID_LAYOUT;
            default:
                if (DEBUG) {
                    Log.d(TAG, "Unknown focus request:" + focusDirection);
                }
                return com.omega.recyclerview.LayoutState.INVALID_LAYOUT;
        }
     ...
     */
    public static class LayoutParams extends com.omega.recyclerview.RecyclerView.LayoutParams {
        ...
        public LayoutParams(com.omega.recyclerview.RecyclerView.LayoutParams source) {
            super(source);
        }
    ...
    class Span {
        ...
        void calculateCachedStart() {
            ...
            if (lp.mFullSpan) {
                ...
                if (fsi != null && fsi.mGapDir == com.omega.recyclerview.LayoutState.LAYOUT_START) {
        ...
        void calculateCachedEnd() {
            ...
            if (lp.mFullSpan) {
                LazySpanLookup.FullSpanItem fsi = mLazySpanLookup
                        .getFullSpanItem(lp.getViewLayoutPosition());
                if (fsi != null && fsi.mGapDir == com.omega.recyclerview.LayoutState.LAYOUT_END) {
         ...
         * {@link #onFocusSearchFailed(View, int, com.omega.recyclerview.RecyclerView.Recycler, com.omega.recyclerview.RecyclerView.State)} for
         ...
         * {@link com.omega.recyclerview.RecyclerView#NO_POSITION} if no such view is found.
         */
        int findOnePartiallyOrCompletelyVisibleChild(int fromIndex, int toIndex,
            ...
            return com.omega.recyclerview.RecyclerView.NO_POSITION;
        }
    ...
    static class LazySpanLookup {
        ...
        int invalidateAfter(int position) {
            ...
            if (endPosition == com.omega.recyclerview.RecyclerView.NO_POSITION) {
    ...
    public static class SavedState implements Parcelable {
        ...
        void invalidateAnchorPositionInfo() {
            mSpanOffsets = null;
            mSpanOffsetsSize = 0;
            mAnchorPosition = com.omega.recyclerview.RecyclerView.NO_POSITION;
            mVisibleAnchorPosition = com.omega.recyclerview.RecyclerView.NO_POSITION;
        }
