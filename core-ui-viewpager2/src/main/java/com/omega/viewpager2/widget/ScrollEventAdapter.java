...
package com.omega.viewpager2.widget;

import static com.omega.viewpager2.widget.ViewPager2.ORIENTATION_HORIZONTAL;
import static com.omega.viewpager2.widget.ViewPager2.SCROLL_STATE_DRAGGING;
import static com.omega.viewpager2.widget.ViewPager2.SCROLL_STATE_IDLE;
import static com.omega.viewpager2.widget.ViewPager2.SCROLL_STATE_SETTLING;
import static com.omega.viewpager2.widget.ViewPager2.ScrollState;
...
import com.omega.viewpager2.BuildConfig;
import com.omega.viewpager2.widget.ViewPager2.OnPageChangeCallback;
    ...
    private void updateScrollEventValues() {
        ...
        if (values.mOffsetPx < 0) {
            ...
            if (new AnimateLayoutChangeDetector(mLayoutManager).mayHaveInterferingAnimations()) {
                String errorMsg = "Page(s) contain a ViewGroup with a "
                ...
                if(BuildConfig.DEBUG) throw new IllegalStateException(errorMsg);
                else {
                    Timber.e(errorMsg);
                }
            }
            ...
            String errorMsg = String.format(Locale.US, "Page can only be offset by a "
